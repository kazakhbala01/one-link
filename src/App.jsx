...
function SafariFrame({url="one-link.kz",src,children,h=420}){
    ...
    return<div style={{position:"relative",zIndex:open?9999:1}}>
        {/* Backdrop — обычный div, не портал */}
        <div style={{
